      ...
      <div onClick={(e) => e.stopPropagation()} className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h3 className="text-center">ULOGUJ SE</h3>
          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit(onFormSubmit)}>
              ...
              <div className="d-flex align-items-top align-content-stretch mt-2">
                ...
                <input className="rounded w-75" type="password" name="password" placeholder="Password" 
                  ref={register({ required: "Morate uneti password!", minLength: { value: 6, message: "Kratak password (mora imati 6 ili više karaktera)!" }})}/>
...
export default connect(null, { login })(PrijavaForma);
